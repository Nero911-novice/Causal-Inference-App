...
from data_prep import prepare_dataframe, read_file, select_period_mask, validate_periods
from interpretation import render_placebo_interpretation, render_stability_interpretation
from models import cumulative_growth_from_series, run_models
from reporting import (
    create_detailed_impact_table,
    create_plot,
